...
export const pragati = require("../assets/images/pragati.png")

export const elysian = require("../assets/images/elysian.PNG")
export const carmell = require("../assets/images/carmell.PNG")
export const rasana  = require("../assets/images/rasanaBuzz.PNG")
export const mittalGroup = require("../assets/images/mittalGroup.PNG")
export const mrjb  = require("../assets/images/mrjb.PNG")
export const daloom  = require("../assets/images/daloom.PNG")
export const jaguar  = require("../assets/images/jaguar.PNG")
export const aryanLifts  = require("../assets/images/aryanlifts.PNG")
export const webinn  = require("../assets/images/webinn.PNG")
export const snk  = require("../assets/images/snk.png")
