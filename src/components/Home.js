...
const SectionTwo = () => {
    return (
        <>
            <div className='p-5 mt-10 xl:px-10'>
                <div>
    ...
    return (
        <>
            <div className='mt-[-3rem] xl:mt-[-9]'>
                ...
                <div className='relative top-[4rem] sm:top-[8rem] lg:top-[12rem]
                  '>
                    <Image
                        className='rounded-[3rem] aspect-auto object-cover px-[1rem] xl:ml-8 '
                ...
                >
                    ...
                    <div className='mt-5 sm:mt-[6rem] lg:mt-[10rem]  xl:mr-[40rem] xl:ml-10'>
                    ...
                    <div className='md:grid md:grid-cols-2 md:gap-5 xl:grid-cols-4 '>
...
const SectionFour = () => {
    ...
    return (
        <>
            <div className='px-5 xl:flex xl:flex-row-reverse xl:justify-center xl:items-center xl:gap-[8rem] '>
...
const SectionFive = () => {
    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center p-[1rem] mt-8 xl:mt-[5rem]'>
                <h2 className='text-[1.5rem] font-[300]'>Blog</h2>
                <h1 className='text-[1.8rem] text-center leading-5 font-he mt-4 font-[600] px-5'>
...
const SectionSix = () => {
    return (
        <div className='bg-[#f7f7f9] mt-10 flex flex-col justify-center items-center pt-[3rem] pb-[5rem]  rounded-t-[4rem]'>
