  ...
  return (
    <div ref={ref} className="container" style={{ display: visible ? 'block' : 'none' }}>
      <table style={{ border: '1px solid white', borderCollapse: 'collapse', width: '1000px', margin: 'auto' }}>
        <tr>
          <td style={{ fontSize: '20px', margin: 0, border: '1px solid white' }}>
            <h1 style={{ fontWeight: 'bold', fontSize: '25px', paddingLeft: '35px', color: '#6c46e4' }}>
              Quotation
            </h1>
            <div style={{ display: 'flex' }}>
              <ul>
                <li style={{ listStyle: 'none', fontSize: '12px' }}>Quotation No #</li>
                <li style={{ listStyle: 'none', fontSize: '12px' }}>Quotation Date</li>
                <li style={{ listStyle: 'none', fontSize: '12px' }}>Valid Till Date</li>
              </ul>
              <ul>
                <li style={{ listStyle: 'none', fontSize: '12px', fontWeight: 'bold' }}>{formData.quotation_no}</li>
                <li style={{ listStyle: 'none', fontSize: '12px', fontWeight: 'bold' }}>{formData.quotation_date}</li>
                <li style={{ listStyle: 'none', fontSize: '12px', fontWeight: 'bold' }}>{formData.valid_date}</li>
              </ul>
            </div>
          </td>
          {/* <td style={{ fontSize: '15px', margin: 0, border: '1px solid white' }} colSpan="2">
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', height: '100%', padding: '10px' }}>
              <img src="crownsetfinal.png" alt="Logo" style={{ width: '100px', height: 'auto', marginRight: '10px' }} />
            </div>
          </td> */}
        </tr>
      </table>
      <table style={{ border: '1px solid white', borderCollapse: 'collapse', width: '1000px', margin: 'auto' }}>
        <tr>
          <td style={{ fontSize: '15px', margin: 0, border: '1px solid white', backgroundColor: '#c9bbf5', width: '50%' }}>
            <ul>
      ...
      <table style={{ border: '1px solid white', borderCollapse: 'collapse', width: '1000px', margin: 'auto', marginTop: '5px' }}>
        <tr>
          ...
          <td style={{ fontSize: '20px', margin: 0, textAlign: 'center', backgroundColor: '#6c46e4', color: 'white' }}>Quantity</td>
          <td style={{ fontSize: '20px', margin: 0, textAlign: 'center', backgroundColor: '#6c46e4', color: 'white' }}>Rate</td>
          <td style={{ fontSize: '20px', margin: 0, textAlign: 'center', backgroundColor: '#6c46e4', color: 'white' }}>Amount</td>
        </tr>
        ...
        <tr>
          <td colSpan="3" style={{ fontSize: '15px', margin: 0, textAlign: 'right', color: 'black', fontWeight: 'bold' }}>Total Amount</td>
      ...
      <table style={{ border: '1px solid white', borderCollapse: 'collapse', width: '1000px', margin: 'auto', marginTop: '5px' }}>
        <tr>
          <td style={{ fontSize: '15px', margin: 0, color: 'black' }}>
