    ...
    <>
      ...
      >
        <div className="mt-8 md:grid md:grid-cols-2 md:gap-4 xl:w-11/12 m-auto">
          <div>
            ...
            xl:text-[4.2rem] xl:leading-[4rem] leading-8 lg:leading-[3rem] font-[700] text-[#560a39] mt-3 tracking-wide"
            >
            ...
            <p className="mt-4 pr-3 lg:pr-9 lg:text-[1.2rem] text-bodyTextColor">
              ...
              businesses to not just participate in the market but to lead
              it.With our innovative business solutions and IT services, we
              transform your ideas into a powerful brand presence. Our expertise
              in marketing, coupled with cutting-edge technology, ensures that
              you don&apos;t just follow trends—you set them. Join us and let
              Crownset turn your business into a brand that stands out and
              thrives.
            </p>
          </div>
      ...
      <section className="xl:w-11/12 m-auto">
        <p className="text-center px-[1rem] text-bodyTextColor text-[0.8rem] md:px-[2rem] lg:text-[1.5rem] lg:w-3/4 lg:m-auto font-semibold ">
          At Crownset Marketing Agency, our mission is to revolutionize
          businesses by delivering exceptional customer service and innovative
          solutions. With over six years of industry experience, we specialize
          in providing comprehensive business solutions tailored to meet your
          unique needs.By choosing Crownset Marketing Agency, you&apos;re partnering
          with a team that is dedicated to your success. We measure our success
          by the results we deliver for our clients, and we are committed to
          helping you achieve tangible, measurable outcomes that drive your
          business forward.
        </p>
      </section>
