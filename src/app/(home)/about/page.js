...
const linkedinUrl = [
  "https://www.linkedin.com/in/garvit-chawla-25084b20b",
  "https://www.linkedin.com/in/priyampathak",
];
const ourValuesIcon = {
...
const Page = () => {
  ...
  const goToPrevious = () => {
    setTimeout(() => {
      const newIndex =
        currentIndex === 0 ? teamData.length - 1 : currentIndex - 1;
  ...
  const goToNext = () => {
    setTimeout(() => {
      const newIndex =
        currentIndex === teamData.length - 1 ? 0 : currentIndex + 1;
      setCurrentIndex(newIndex);
    }, 300);
  };
  ...
  return (
    <>
      <section
        style={{
          background: "linear-gradient(0deg, white, rgb(234, 232, 255) 80%)",
        }}
        className="px-5 py-3 "
      >
        <div className="mt-8 md:grid md:grid-cols-2 md:gap-4 xl:w-11/12 m-auto">
          <div>
            ...
            <h1
              className="text-[2rem] md:text-[3rem] md:leading-[3rem]
            xl:text-[3rem] xl:leading-[4rem] leading-8 lg:leading-[3rem] font-[600] text-[#560a39] mt-3 tracking-wide"
            >
               Excellence is in our Blood ,
            </h1>
            <p className="mt-4 pr-3 lg:pr-9 lg:text-[1.2rem] text-bodyTextColor">
              At Crownset, founded in 2017, we are dedicated to empowering
              businesses to not just participate in the market but to lead it.
              With over 7th years of industry experience, we transform your
              ideas into a powerful brand presence through our innovative
              business solutions and IT services. Our expertise spans digital
              marketing, app development, ensuring that your business doesn’t
              just follow trends—it sets them. By combining cutting-edge
              technology with our strategic insights, we help you build a brand
              that stands out and thrives in today’s competitive landscape. Join
              us at Crownset, and let us turn your business vision into reality
              with solutions that drive growth and create lasting impact.
            </p>
          </div>
      ...
      <section className="xl:w-11/12 m-auto">
        <p className="text-center px-[2rem] text-black text-[0.8rem] md:px-[2rem] lg:text-[1.5rem] lg:w-3/4 lg:m-auto font-semibold ">
          Our mission at Crownset Marketing Agency is to revolutionize companies
          by providing outstanding customer service and creative solutions. With
          more than six years of expertise, we are experts in offering complete
          business solutions that are customized to your particular
          requirements.
        </p>
      </section>

      <section
        className=" hidden xl:pt-1 px-[1rem]  pb-[2rem] mt-10"
        style={{
          background: "linear-gradient(0deg, white, rgb(234, 232, 255) 80%)",
        }}
      >
        <div className="">
          <div className="mt-5 xl:w-11/12 m-auto">
            <h2 className="text-[1.4rem] font-[625] text-center">
              OUR PROFICIENCY
            </h2>
          </div>
          ...
          <div className="md:grid md:grid-cols-2 md:gap-5 xl:grid-cols-4 xl:w-11/12 m-auto ">
            <CardFour
              icon={
                <Icon
                  icon={
                    <BulbIcon className="text-primary-color size-[1.5rem]" />
                  }
                />
              }
            ...
            <CardFour
              icon={
                <Icon
                  icon={
                    <TargetArrowIcon className="text-primary-color size-[1.5rem]" />
                  }
                />
              }
            ...
            <CardFour
              icon={
                <Icon
                  icon={
                    <CgWebsite className="text-primary-color size-[1.5rem]" />
                  }
                />
              }
            ...
            <CardFour
              icon={
                <Icon
                  icon={
                    <BsTranslate className="text-primary-color size-[1.5rem]" />
                  }
                />
              }
  ...
  "
          ...
          <div
            className="px-[1rem] pt-[4rem] pb-[2rem] "
            style={{
              background:
                "linear-gradient(0deg, white, rgb(234, 232, 255) 80%)",
            }}
          >
            <div
              className="mt-5 sm:mt-[6rem] lg:mt-[10rem]  
            xl:w-11/12 m-auto"
            >
              <h2 className="text-[1.4rem] font-[625] text-center">
                OUR VALUES
      ...
      <section className="px-5 mt-20 xl:mt-[10rem] xl:w-11/12 m-auto">
        <div className="sm:grid sm:grid-cols-2 sm:gap-5 xl:gap-[6rem]">
          <div>
            <h2 className="font-semibold mr-10 ">
              BUSINESS SOLUTIONS PROVIDER
            </h2>
            <h1
              className="text-[1.8rem] sm:text-[2.2rem] lg:text-[2.5rem] 
            font-bold leading-9 mt-6 xl:text-[4rem] xl:leading-[4rem]"
            >
              {" "}
              We&apos;re a leader in IT services and Business solutions
            </h1>
          </div>
          <div className="mt-6">
            <p className="text-bodyTextColor">
              After years of experience, we&apos;ve learned that each service
              area offers unique advantages. To maximize these benefits, we
              strategically combine them to create comprehensive solutions. We
              provide our clients with full-service strategies that include
              business solutions, IT services, and digital marketing, enhancing
              visibility, boosting conversions, and driving revenue.
            </p>
            <Link href="/services">
      ...
      <section className="mt-10 px-5 hidden">
        <div className="flex items-center justify-center gap-5 py-10 max-md:flex-col">
          ...
          <div className="flex items-center justify-center gap-8  max-md:flex-wrap">
            <div>
              <Image
                src="https://thecrownset.com/wp-content/uploads/elementor/thumbs/56cf51c7d935aba26a8f553867bf878b-qql2z74lvkd216ad5m0wcz170nmakss1bbb0a7qwps.png"
                alt="logo"
                width={70}
                height={70}
              />
            ...
            <div>
              <Image
                src="https://thecrownset.com/wp-content/uploads/elementor/thumbs/new-badge20220412-1161242-19o8jy5-qql30lvw4majg48mx7yr3m833go44gdjiaj875nnds.png"
                alt="logo1"
                width={70}
                height={70}
              />
            ...
            <div>
              <Image
                src="https://thecrownset.com/wp-content/uploads/elementor/thumbs/new-badge20211006-5432-t7lh3l-qql30ky1xs994ia02pk4j4gmi2sqwr9t65vqpvp1k0.png"
                alt="logo2"
                width={70}
                height={70}
              />
            ...
            <div>
              <Image
                src="https://thecrownset.com/wp-content/uploads/elementor/thumbs/new-badge20211005-28345-8m8kvp-qql30ky1xs994ia02pk4j4gmi2sqwr9t65vqpvp1k0.png"
                alt="logo3"
                width={70}
                height={70}
              />
            ...
            <div>
              <Image
                src="https://thecrownset.com/wp-content/uploads/elementor/thumbs/logo_hubspot-qql30k095dt7mir8bgo0ky5rnpjx6t3am36ozba0v4.png"
                alt="logo3"
                width={70}
                height={70}
              />
